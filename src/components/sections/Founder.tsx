...
export default function Founder() {
  return (
    <section
      id="team"
      className="relative flex min-h-[calc(100dvh-var(--header-h,88px))] scroll-mt-[var(--header-h,88px)] flex-col justify-center px-6 pb-12 pt-10 lg:px-8"
    >
      <div className="mx-auto max-w-6xl text-center">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <div className="panel mx-auto flex h-full flex-col items-center gap-3 rounded-2xl p-6 text-center sm:p-7">
            <img
              src={`${import.meta.env.BASE_URL}images/nandu-mahajan.jpg`}
              alt="Nandu Mahajan"
              className="h-16 w-16 shrink-0 rounded-full border border-cobalt-bright/30 object-cover shadow-glow-cobalt"
            />

            <div>
              <p className="text-base font-semibold text-slate-50">Nandu Mahajan</p>
            ...
            <div className="mt-auto flex items-center gap-3">
              <a
                ...
                aria-label="LinkedIn"
                className="flex h-8 w-8 items-center justify-center rounded-full border border-white/15 text-slate-300 transition-colors hover:border-cobalt-bright/50 hover:text-cobalt-bright"
              >
